          ...
          <ScrollView style={{ width: '100%', }}>
            ...
            <TouchableOpacity style={styles.card}
              ...
              <View style={styles.heart}>
                <TouchableOpacity
                    style={[styles.btn, { alignSelf:"flex-start",zIndex: 5, padding: 0,position:"absolute", top:170,right:5, height: 25, width: 100}]}
                    >
                    <LinearGradient
                        start={{ x: 0, y: 0 }}
                        end={{ x: 0, y: 1 }}
             ...
             <View
                ...
                <View style={{
                    ...
                    alignItems:"flex-end"
                        ...
                        <TouchableOpacity onPress={()=> setDelete(true)} style={{alignItems:"center"}}>
...
<View style={{
        ...
        {activity ? (
          <ScrollView>
            ...
            <TouchableOpacity style={styles.card}>
              ...
              />
              <View  >
                <Text style={styles.headingText}>Castelfranco MO</Text>
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
          ...
          <ScrollView style={styles.modalView2}>
            ...
            <View style={styles.middleSec}>
              ...
              {activity ? (
                <ScrollView>
                  <TouchableOpacity
                    onPress={() => navigation.navigate('AdminActivityDetail1')}
                    style={styles.card}>
                    <View style={styles.heart}>
                      <TouchableOpacity
                        styles={{ paddingVertical: 20, zIndex: 5 }}
      ...
      {deleteModal ? <DeleteEvent setModalVisible={setDelete} />:null }
