...
import { Switch } from 'react-native-switch';
  ...
  const ManageOwners = ({ navigation }) => {
    ...
    const NoOfowners = new Array(10).fill(0)
    const [isEnabled, setIsEnabled] = useState(new Array(NoOfowners.length).fill(true));
    ...
    return (
      <View style={ styles.Menu}>
        ...
        <Text style={[styles.HeadingText, {fontSize:30, lineHeight:45 ,color:"#22AEB3", marginVertical:15}]}>Owners</Text>      
        <ScrollView style={{width:"100%"}}>
        {/* Owners Mapping */}
        { NoOfowners.map((val, index) => 
            <View key={index}>
                <View style={{flexDirection:"row", justifyContent:"space-between", alignItems:"center", marginVertical:10, marginHorizontal: 20}}>
                    <View>
                        ...
                        <View style={{flexDirection:"row", justifyContent:"space-evenly", alignItems:"center",marginTop:5,}}>
                            <Ionicons name='star-sharp' size={15} color={"rgb(255, 206, 49)"} />
                            <Text style={styles.subText}>4.9</Text>
                        </View>
                    </View>
                    <View>
                        <TouchableOpacity onPress={()=> navigation.navigate('OwnerStats')}>
                          <Text style={styles.text}>David deep</Text>
                        </TouchableOpacity>
                        <Text style={styles.subText}>21 March, 2022</Text>
                        <View style={{flexDirection:"row", marginTop:5,}}>
                            <Ionicons name='ios-heart' size={15} color={"rgb(255,0, 0)"} />
                            <Text style={styles.subText}>700+</Text>
                        </View>
                    </View>
                ...
                { index !== NoOfowners.length-1 ? 
                <Divider horizontalInset style={{marginVertical:5}} />
                : null
                }
            </View>
        )}
