...
const EditActivityDetail2 = ({ navigation }) => {
    ...
    const [modalOpps, setModalOopsle] = useState(true);
    // const [modalUsetProfile, setModalUsetProfile] = useState(false);
    ...
    return (
        <ScrollView
            ...
            <View style={{
                ...
                <TouchableOpacity
                    onPress={()=> navigation.navigate("OwnerCreateEventDetail", {  EventName: event? "Event":"Activity" })}
            ...
            <View style={{ padding: 20, width: '90%' }}>
                ...
                <View style={{ flexDirection: 'row', paddingVertical: 10, }}>
                    ...
                    <Text style={[styles.disText, { width: '80%' }]}><MaterialIcons name={'location-pin'} size={13} color={'white'} />Via Emilia Ovest, 23, 41124 Modena MO</Text>
                </View>
                <View style={{
...
Sabato	Chiuso`} </Text>
                ...
                <View style={styles.reviewSec}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={{ color: '#56D4FA' }}>Apri</Text>
                    </TouchableOpacity>
                </View>
                ...
                <TouchableOpacity style={{width:"80%",height:"7%", marginVertical:"4%", alignSelf:"center"}} 
                    onPress={()=>navigation.navigate("OwnerSponsorEvent")}>
                    <LinearGradient
                    start={{ x: 0, y: 0 }}
                    end={{ x: 0, y: 1 }}
                    colors={['#33CC8F','#28CCF2']}
                    style={[styles.gradient, {borderRadius:20}]}>
                    <Text style={[styles.btn1text,{color:"white", fontSize:16}]}>INCREASE YOUR VISIBILITY</Text>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
            {/* ---------------Discription Popup-------------------- */}
                    ...
                    <ScrollView style={styles.modalView2}>
                        ...
                        <View style={styles.middleSec}>
                            ...
                            {activity ? (
                                <ScrollView>
                                    <TouchableOpacity
                                        onPress={() => navigation.navigate('OwnerActivityDetail')}
                                        style={styles.card}>
                                        <View style={styles.heart}>
                                            <TouchableOpacity
                                                styles={{ paddingVertical: 20, zIndex: 5 }}
                                    ...
                                    <TouchableOpacity style={styles.card}
                                        onPress={() => navigation.navigate('OwnerActivityDetail2')}>
                                        <View style={styles.heart}>
                                            <TouchableOpacity
                                                styles={{ paddingVertical: 20, zIndex: 5 }}   >
                                                <Ionicons
...
export default EditActivityDetail2;
