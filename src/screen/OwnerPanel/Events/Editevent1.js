        ...
        <ScrollView
            ...
            <View style={{ padding: 20, width: '90%' }}>
                ...
                <View style={{ flexDirection: 'row', paddingVertical: 10, }}>
                    ...
                    <Text style={[styles.disText, { width: '80%' }]}><MaterialIcons name={'location-pin'} size={13} color={'white'} />Via Alfonso Paltrinieri, 1, 41122 Modena MO</Text>
                </View>
                ...
                <TouchableOpacity style={{width:"80%",height:"12%", marginVertical:"4%", alignSelf:"center"}} 
