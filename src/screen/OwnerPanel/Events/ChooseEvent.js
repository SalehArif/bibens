            ...
            <ScrollView>
              <TouchableOpacity
                ...
                <View
                  ...
                  {selected == 0 ? (
                      <TouchableOpacity
                        style={{backgroundColor: '#2DC19D',borderRadius: 5 ,marginBottom:"11%", marginTop:"3%"}}
                        onPress={() => setSelected(-1)}>
                        <AntDesign
                          name="check"
                          style={{
                    ...
                    <TouchableOpacity
                      style={{backgroundColor: '#BBB7B7', borderRadius: 5 ,marginBottom:"11%", marginTop:"3%"}}
                      onPress={() => setSelected(0)}>
          ...
          {activity ? (
            <ScrollView>
              <TouchableOpacity
                ...
                key={0}
                style={[styles.card, selected == 3 ? styles.border : null]}>
                <View style={styles.heart}>
                  <TouchableOpacity
              ...
              <TouchableOpacity
                style={[styles.card, selected == 4 ? styles.border : null]}
                key={1}
        ...
        <View style={styles.centeredView}>
          <View
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('OwnerPaymentMethod')}>
              <LinearGradient
                start={{x: 0, y: 0}}
                end={{x: 0, y: 1.7}}
