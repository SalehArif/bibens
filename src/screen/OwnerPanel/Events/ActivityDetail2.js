...
const ActivityDetail2 = ({ navigation }) => {
        ...
        <ScrollView
            ...
            <View style={{ padding: 20, width: '90%' }}>
                ...
                <View style={{ flexDirection: 'row', paddingVertical: 10, }}>
                    ...
                    <Text style={[styles.disText, { width: '80%',paddingLeft:10 }]}><MaterialIcons name={'location-pin'} size={13} color={'white'} />Via Emilia Ovest, 23, 41124 Modena MO</Text>
                </View>
                <View style={{
...
Sabato	Chiuso`} </Text>
                ...
                <View style={[styles.reviewSec,{paddingHorizontal:5}]}>
                    <View>
