...
const EditEventDetail = ({ navigation }) => {
    ...
    return (
        <ScrollView
            ...
            <View style={{ paddingHorizontal: 20, width: '95%' }}>
                ...
                ><Text style={[styles.headingText, { width: 70, color: '#56D4FA', padding: 0, borderBottomColor: '#56D4FA', borderBottomWidth: 1, }]}>{'See All'}</Text>
                </TouchableOpacity>
                <View style={{ flexDirection: 'row', paddingVertical: 10, }}>
                    <Text style={styles.headingText}>Place:</Text>
                    <Text style={styles.disText}>Via Alfonso Paltrinieri</Text>
                </View>
                <Text style={styles.headingText}> Opening days and time:</Text>
                ...
                <View style={styles.reviewSec}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={{ color: '#56D4FA' }}> See All</Text>
                    </TouchableOpacity>
                </View>
                <Text style={[styles.headingText, { paddingVertical: 10 }]}>
                    Organizer
                ...
                <View style={styles.reviewSec}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={{ color: '#56D4FA' }}> See Profile</Text>
                    </TouchableOpacity>
                </View>
