  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.middleSec}>
        ...
        {event ? (
          <ScrollView style={{ width: '100%', }} contentContainerStyle={{paddingBottom: 30}}>
            ...
            <TouchableOpacity style={styles.card}
              onPress={() => navigation.navigate('EventDetail',{guest:route.params?.isGuest})}>
            ...
            <TouchableOpacity style={styles.card}
              onPress={() => navigation.navigate('Event1',{guest:route.params?.isGuest})}>
              <View style={styles.heart}>
        ...
        {activity ? (
          <ScrollView contentContainerStyle={{paddingBottom: 30}}>
            <TouchableOpacity
              onPress={() => navigation.navigate('ActivityDetail',{guest:route.params?.isGuest})}
              style={styles.card}>
              <View style={styles.heart}>
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate('ActivityDetail2',{guest:route.params?.isGuest})}
              style={styles.card}>
              <View style={styles.heart}>
      ...
      <View style={styles.bottemSec}>
        <Menu navigation={navigation} guest={route.params?.isGuest} showLoginError={setModalOopsle} />
      </View>
      ...
      <Modal
        ...
        <View style={[styles.centeredView]}>
          <ScrollView
            style={[styles.modalView, {borderRadius:15}]}
          >
            <TouchableOpacity
              onPress={() => setModalVisible(!modalVisible)}
          ...
          <ScrollView style={styles.modalView2}>
            ...
            <View style={styles.middleSec}>
              ...
              {activity ? (
                <ScrollView contentContainerStyle={{paddingBottom: 30}}>
                  <TouchableOpacity
                    onPress={() => navigation.navigate('ActivityDetail1',{guest:route.params?.isGuest})}
                    style={styles.card}>
                    <View style={styles.heart}>
                      <TouchableOpacity
                        styles={{ paddingVertical: 20, zIndex: 5 }}
              ...
              <View style={[styles.serSec]}>
                ...
                <View style={[styles.innseserch,]}>
                  {/* <Image
                    ...
                    style={{ margin: 10 }}
                  /> */}
                <Ionicons name='search' size={25} style={{ margin: 10 }} />
                  <GooglePlacesAutocomplete
                    autoFocus={false}
                    fetchDetails={true}
