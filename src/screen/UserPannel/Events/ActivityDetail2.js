...
const ActivityDetail2 = ({ navigation, route }) => {
        ...
        <ScrollView
            ...
            <View style={styles.mainMenu}>
                <TouchableOpacity
                    ...
                    <Text style={styles.actEventtext}>Preferiti</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                    ...
                    <Text style={styles.actEventtext}>Condividi</Text>
                </TouchableOpacity>
                <View style={styles.strightBar}></View>
                <TouchableOpacity
                    style={styles.activityEventSection}
                    ...
                    <Text style={styles.actEventtext}>Mappa</Text>
                </TouchableOpacity>
                <View style={styles.strightBar}></View>
                <TouchableOpacity
                    style={styles.activityEventSection}
                    ...
                    <Text style={styles.actEventtext}>Contatta</Text>
                </TouchableOpacity>
            </View>
            <View style={{ padding: 20, width: '90%' }}>
                ...
                {/* <ViewMoreText
                    numberOfLines={3}
                    textStyle={{ color: '#56D4FA', }}
                >
                    <Text style={styles.disText}>
                        Il metodo Pilates è una ginnastica che insegna ad assumere una corretta postura e a dare maggiore armonia e fluidità nei movimenti. L'obiettivo del suo ideatore era...</Text>
                </ViewMoreText> */}
                ...
                <View style={{ flexDirection: 'row', paddingVertical: 10, }}>
                    ...
                    <Text style={[styles.disText, { width: '80%', marginLeft:10 }]}><MaterialIcons name={'location-pin'} size={13} color={'white'} />Via Emilia Ovest, 23, 41124 Modena MO</Text>
                </View>
                <View style={{
                    ...
                    <Text style={[styles.disText,]}>12 Mar 2022</Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingBottom: 10, }}>
                    <Text style={styles.headingText}>Data di fine attività:</Text>
                    <Text style={[styles.disText,]}>18 Nov 2022</Text>
                </View>
                <Text style={styles.headingText}>Giorni e orari di apertura:</Text>
                <Text style={styles.disText}>{`Domenica	Chiuso
Lunedì	18:30 - 20
Martedì
Chiuso
Mercoledì	18:30 - 20
...
Sabato	Chiuso`} </Text>
                ...
                <Text style={styles.disText}>Wednsday Chiuso </Text>
                <Text style={styles.disText}>Thursday</Text>
                <Text style={styles.disText}> 20–01 Friday </Text>
                <Text style={styles.disText}>20–02 Saturday 16–02</Text> */}
                ...
                <View style={styles.reviewSec}>
                    <View
                        ...
                        />
                        <Text style={styles.headingText}>Daniele Rossi</Text>
                    </View>
                    ...
                    >
                        <Text style={{ color: '#56D4FA' }}>Mostra Profilo</Text>
                    </TouchableOpacity>
                </View>
            </View>
            {/* ---------------Discription Popup-------------------- */}
            ...
            <Modal
                ...
                <View style={styles.centeredView2}>
                    <ScrollView style={styles.modalView2}>
                        ...
                        <Text style={styles.disText}>Alberto</Text>
                        {showProfdiscription ?
                            <View>
                                <Text style={[styles.modalHeadingText, { color: 'white' }]}>
                                    Email address{' '}
            ...
            <Modal
                ...
                visible={modalOpps}
                onRequestClose={() => {
                    setModalOopsle(!modalOpps);
                }}>
                <View style={styles.centeredOpp}>
                    <View style={styles.modalOop}>
                        <Text
                            style={[
                                styles.modalHeadingText,
                                { fontSize: 28, paddingBottom: 15, lineHeight:30, marginTop:10 },
                            ]}>
                            OPS....!
                        </Text>
                        <Text
                            ...
                            To use this function you need to have a personal account
                        </Text>
                        <Text
                            style={[styles.checkboxText, { paddingBottom: 0, paddingTop: 20 }]}>
                        ...
                        <TouchableOpacity
                            ...
                            <LinearGradient
                                ...
                                colors={['#33CC8F', '#28CCF2']}
                                style={styles.gradient}>
                                <Text style={[styles.btntext, { textTransform: 'uppercase', color: 'white' }]}>Sign  in</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                        <Text style={[styles.checkboxText, { paddingBottom: 0, paddingTop: 20 }]}>
                        ...
                        <TouchableOpacity
                            ...
                            <LinearGradient
                                ...
                                colors={['#33CC8F', '#28CCF2']}
                                style={styles.gradient}>
                                <Text style={[styles.btntext, { textTransform: 'uppercase', color: 'white' }]}>Sign UP</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </View>
                </View>
