...
const Organizor = ({ navigation, route }) => {
            ...
            <View style={styles.middleSec}>
                ...
                {event ? (
                    <ScrollView>
                        <TouchableOpacity
                            style={styles.card}
                            onPress={()=> navigation.navigate("OwnerEditEventDetail")}
                            >
                        ...
                        <TouchableOpacity style={styles.card}
                            onPress={() => navigation.navigate('OwnerEditEvent1')}
                        >
                            <View style={styles.heart}>
                ...
                {activity ? (
                    <ScrollView>
                        <TouchableOpacity
                            onPress={() => navigation.navigate('OwnerEditActivityDetail')}
                            style={styles.card}>
                            <View style={styles.heart}>
                                <TouchableOpacity
                                    styles={{ paddingVertical: 20, zIndex: 5 }}
                        ...
                        <TouchableOpacity style={[styles.card,{marginBottom:"30%"}]}
                            onPress={() => navigation.navigate('OwnerEditActivityDetail2')}>
                            <View style={styles.heart}>
                                <TouchableOpacity
                                    styles={{ paddingVertical: 20, zIndex: 5 }}   >
                                    <Ionicons
