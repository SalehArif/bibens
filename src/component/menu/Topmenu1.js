  ...
  return (
    <View style={styles.mainMenu}>
      <LinearGradient
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('OwnerCreateEvent')}
          style={{ alignItems: 'center' }}>
          {/* <Image
                source={require('../../Assets/hb.png')}
                style={{ width:28,height:25}}
              /> */}
          <Feather name={'plus'} size={30} color={'#2B2B2B'} />
          <Text style={{ color: '#2B2B2B' }}>Create</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => navigation.navigate('OwnerProfile', {Editable: true})} //change to profile
          style={{ alignItems: 'center' }}>
          {/* <Image
